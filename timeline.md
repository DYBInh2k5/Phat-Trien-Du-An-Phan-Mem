...
## Tuần 1: Phân tích Yêu cầu & Khởi tạo Dự án
...
- Viết tài liệu SRS khởi tạo tại BrainStorm/Week1.md.
- Lựa chọn Bộ công nghệ chính thức từ Tech.md.

---

## Tuần 2: Thiết kế Kiến trúc CSDL & Wireframe Giao diện
...
## Tuần 3: Xây dựng Module Tài khoản & Phân quyền (Auth & RBAC)
...
## Tuần 4: Xây dựng Module Quản lý Học sinh, Lớp học & Thời khóa biểu
...
## Tuần 5: Xây dựng Module Sổ điểm Điện tử & Tự động tính GPA
...
## Tuần 6: Xây dựng Module Điểm danh & Quản lý Học phí
...
## Tuần 7: Module Xuất Báo cáo (Excel/PDF) & Kiểm thử Unit Test
...
## Tuần 8: Hoàn thiện, Đóng gói & Báo cáo Demo Dự án SMS
